...
RUN git clone -v -b py3 https://github.com/caozhichongchong/meta_decoder.git && cd meta_decoder && git clone https://bitbucket.org/yonatanf/strainfinder && cd strainfinder && python2 setup_cython.py build_ext --inplace
