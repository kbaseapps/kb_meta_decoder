...
RUN apt-get update && apt-get install -y bowtie samtools bcftools bedtools emboss python3-pip wget zlib1g-dev emacs bc gawk vcftools r-cran-ggplot2 curl libcurl4-openssl-dev libssl-dev gnuplot python-pip python-numpy
