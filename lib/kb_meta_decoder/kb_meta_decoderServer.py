...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_meta_decoder'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_meta_decoder.kb_meta_decoderImpl import kb_meta_decoder  # noqa @IgnorePep8
impl_kb_meta_decoder = kb_meta_decoder(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_meta_decoder'
        ...
        self.rpc_service.add(impl_kb_meta_decoder.call_variants_single,
                             name='kb_meta_decoder.call_variants_single',
                             types=[dict])
        self.method_authentication['kb_meta_decoder.call_variants_single'] = 'required'  # noqa
